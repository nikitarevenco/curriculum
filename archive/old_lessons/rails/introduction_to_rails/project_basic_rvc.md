...
In this chapter of the tutorial you will build out the look and feel of the application using X's Bootstrap CSS framework.  If you're feeling shaky on CSS, check out the [CSS Lesson in the Foundations course](/courses/foundations/lessons/html-and-css-basics).
