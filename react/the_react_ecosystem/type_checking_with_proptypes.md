...
In the future however, if you do decide to go in the direction of learning TypeScript, our recommendation would be to first go through the [official typescript handbook](https://www.typescriptlang.org/docs/handbook/intro.html) and then picking up a previous project and refactoring the components one by one to TypeScript.
